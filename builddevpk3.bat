...
echo Compressing...
zip.exe -9r pak6-patch088b-%now%-temp.pk3 docs/*
zip.exe -9r pak6-patch088b-%now%-temp.pk3 levelshots/*
zip.exe -9r pak6-patch088b-%now%-temp.pk3 maps/*
zip.exe -9r pak6-patch088b-%now%-temp.pk3 models/*
